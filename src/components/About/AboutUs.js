...
const AboutUs = () => {
    ...
    <div class="container mx-auto">
        ...
        <img class="w-screen h-screen object-cover object-top" src="https://technext.github.io/novena/images/about/about-4.jpg" alt=""/>
      </div>
      <div class="flex bg-gray-100 p-10">
        <div class="mb-auto mt-auto max-w-lg">
          <h1 class="text-3xl uppercase">Dr: Jun Santilla</h1>
          <p class="font-semibold mb-5">Founder</p>
          <p>Today’s users expect effortless experiences. Don’t let essential people and processes stay stuck in the past. Speed it up, skip the hasslesNostrum odio qui,consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</p>
          <button class="bg-red rounded-md py-3 px-7 mt-6 text-white">Email Me</button>
        </div>
      </div>
    </div>
  </div>
...
<div id="features" class="relative w-full px-1 py-24 border-t border-gray-200 md:py-1 lg:py-0 xl:py-0 xl:px-0">
            ...
            <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Healthcare for Kids</h4>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Medical Counseling</h4>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">Qualified Doctors</h4>
